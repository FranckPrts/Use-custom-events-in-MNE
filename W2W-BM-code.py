...
context = 'form' # form book puzzle movie
...
ibc_metric = 'plv' # Hypyp documentation https://hypyp.readthedocs.io/en/latest/
    ...
    try: 
        ...
        try:
            ...
            np.save("{}W2W-IBC/{}_{}_{}IBC.npy".format(
                save_path, dyad, context, ibc_metric),
...
# Save the droplog
with open('{}W2W-IBC_droplog/{}_droplog.txt'.format(save_path, context), 'w') as f:
    f.write('In context {}, non_epoch_dyads are {}, no_dropChan_dyads are {}'.format(context, non_epoch_dyads, no_dropChan_dyads))
f.close()
